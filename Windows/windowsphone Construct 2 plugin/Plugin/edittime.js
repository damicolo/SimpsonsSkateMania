...
AddAction(12, af_none, "Rate App", "Windows Phone", "Rate App", "Launch the Marketplace and then display the review page for the current app", "RateApp");
...
AddStringParam("App ID", "The App ID (e.g. \"c14e93aa-27d7-df11-a844-00237de2db9e\")");
AddAction(14, af_none, "Launch Marketplace Details", "Windows Phone", "Launch Marketplace Details for App ID <b>{0}</b>", "Launch the Marketplace and display the details page for the specified app", "LaunchMarketplaceDetails");
